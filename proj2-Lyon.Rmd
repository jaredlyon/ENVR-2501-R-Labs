...
## 2.
```{r}
# Build contingency table based on data
...
```
The data does not suggests that northwards movement is slightly more likely for Nonplank species, whereas southwards movement is slightly more likely for Plankfeed and Planknonfeed species. However, these differences do not appear to be overwhelmingly statistically significant, since the delta between the migration patterns of each development type do not exceed a difference of 3.

## 3.
The datatable that is being tested is a contingency table whose response and explanatory variables are categorical. Therefore, the best test for this contingency table is a chisq test.
...
```
A p-value od 0.5196 suggests a statistically insignificant results; we can therefore accept the null hypothesis. Due to the large p-value, we can thus assume that the migration direction of a species is independent of its development.
